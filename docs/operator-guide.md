...
2. Define consent and purpose categories for sprayer/shop records.
...
- safety-critical escalation path (fume exposure, inadequate
  ventilation, flammable-material risk)
- provenance for all operating records (sprayer and shop both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a
  spray-application-execution decision, or a shop-safety-officer-
